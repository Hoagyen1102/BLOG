$(document).ready(function () {
    ...
    $("#form-static_pages").submit(function(e) {
        ...
        var title_slug = $('#form-static_pages').find('input[name="static_page[title_slug]"]').val();
    ...
    $("#form-static_pages-edit").submit(function(e) {
        ...
        var oEditor = CKEDITOR.instances.editor1;
        var content = oEditor.getData();
        var title_slug = $('#form-static_pages-edit').find('input[name="static_page[title_slug]"]').val();
